...
namespace WebCoreNetApi.Controllers
{
    public class Messages1Controller : Controller
    {
        ...
        public Messages1Controller(ArduinoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
